...
<body>
	...
	<main class="container-fluid">
		...
		<form onsubmit="updateBike()" style="visibility: hidden" id="continue">
			<h6>Remove the bike</h6>
			<jsp:include page="message.jsp"></jsp:include>

			<p>
				<label for="km"><strong>Update Odometer reading: </strong></label> <input
					type="number" id="km" name="km" max=300000 required="required">
				<label for="price"><strong>Update price: </strong></label> <input
